  ...
  list: [
      ...
      descriptions: [
        {
          ...
          descriptions: [
            {
              content:
                'Android Native GPS와 장바구니 상품의 오프라인 매장 좌표값 비교하여 가까울 때 Push 알림 구현',
            },
          ],
        },
      ],
    },
    {
      ...
      descriptions: [
        {
          content:
            '종이 명함을 Digital Transformation하여 전자 명함을 App에서 관리하고 NFC를 활용하여 교환할 수 있는 서비스',
          weight: 'MEDIUM',
          descriptions: [{ content: 'Android Native NFC 기능 구현' }],
        },
      ],
    },
  ],
