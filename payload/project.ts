...
const project: IProject.Payload = {
  ...
  list: [
    ...
    },
    {
      ...
      endedAt: '2022-01',
      where:
        'SK(주), 전기차 장기 렌트 고객 대상 차량 관리 편의 제공 서비스 (계약 관리, 정비 관리 등)',
      descriptions: [
        { content: 'Spring Boot Framework를 활용하여 Backend API 개발' },
    ...
    },
    {
      ...
      descriptions: [
        {
          content:
            '3대 CSP의 K8s환경(AWS-EKS, Azure-AKS, GCP-GKE)에서의 EFK Stack으로 Logging System 구축',
          weight: 'MEDIUM',
          descriptions: [
            {
    ...
    },
    {
      ...
      descriptions: [
        ...
        {
          content:
            'EAI System 개발(각 점포에서 쌓은 DB Data를 가져와서 실시간으로 매출(MSSQL), 영업(Oracle), 마케팅(MSSQL) DB로의 Parsing 및 전달하는 시스템)',
          weight: 'MEDIUM',
        },
        {
